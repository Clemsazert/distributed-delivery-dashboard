...
// Settings
const SERVER_PORT = process.env.PORT || 5000; // Listening port
// Optional challenge: set this to have requests to backend randomly failing
const REQUEST_SUCCESS_RATE = process.env.REQUEST_SUCCESS_RATE ? Number(process.env.REQUEST_SUCCESS_RATE) : 1;
